...
var RadioTermSelector = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(RadioTermSelector, _Component);
  ...
  function RadioTermSelector() {
    ...
    _this.onChangeFormName = _this.onChangeFormName.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.onChangeFormParent = _this.onChangeFormParent.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.onAddTerm = _this.onAddTerm.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.onToggleForm = _this.onToggleForm.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(RadioTermSelector, [{
    ...
    value: function onAddTerm(event) {
      ...
      if (existingTerm) {
        ...
        if (!Object(lodash__WEBPACK_IMPORTED_MODULE_9__["some"])(terms, function (term) {
          ...
          onUpdateTerms([existingTerm.id], // @helgatheviking
          taxonomy.rest_base);
        }
      ...
      findOrCreatePromise.then(function (term) {
        ...
        var termAddedMessage = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__["sprintf"])(
        /* translators: %s: taxonomy name */
        Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__["_x"])('%s added', 'term'), Object(lodash__WEBPACK_IMPORTED_MODULE_9__["get"])(_this2.props.taxonomy, ['labels', 'singular_name'], slug === 'category' ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__["__"])('Category') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__["__"])('Term')));
    ...
    value: function setFilterValue(event) {
      ...
      var resultsFoundMessage = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__["sprintf"])(
      /* translators: %d: number of results */
      Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__["_n"])('%d result found.', '%d results found.', resultCount), resultCount);
    ...
    value: function renderTerms(renderedTerms) {
      ...
      return renderedTerms.map(function (term) {
        ...
        var selected = terms.indexOf(term.id) !== -1 ? term.id : 0;
        ...
        }), !!term.children.length && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
    ...
    value: function render() {
      ...
      var _this$props5 = this.props,
          ...
          hasAssignAction = _this$props5.hasAssignAction;
      var klass = taxonomy.hierarchical ? 'hierarchical' : 'non-hierarchical'; // @helgatheviking
      ...
      }, this.renderTerms('' !== filterValue ? filteredTermsTree : availableTermsTree), taxonomy.radio_no_term && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
        key: "no-term",
        className: 'editor-post-taxonomies__' + klass + '-terms-choice '
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["RadioControl"], {
...
}), _wordpress_components__WEBPACK_IMPORTED_MODULE_11__["withSpokenMessages"], _wordpress_compose__WEBPACK_IMPORTED_MODULE_13__["withInstanceId"]])(RadioTermSelector));
